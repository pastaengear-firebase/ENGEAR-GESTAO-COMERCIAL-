...
export default function QuotesTable({
  ...
  onEdit,
  onDelete,
  disabledActions: globalDisabled,
}: QuotesTableProps) {
  ...
  const getFollowUpDateClass = (
    followUpDateStr?: string | null,
    followUpDone?: boolean
  ): string => {
    if (followUpDone) return "text-green-600";
    ...
    try {
      ...
      if (isToday(followUpD)) return "text-blue-600 font-semibold";
                    ...
                    {quote.followUpDate ? (
                      <div className="flex items-center space-x-2">
                        {quote.followUpDone ? (
                          ...
                          <BellRing className={cn("h-4 w-4", getFollowUpDateClass(quote.followUpDate, quote.followUpDone))} />
                        )}
                        ...
                        {!areActionsDisabled && (
                          <div className="flex items-center space-x-1">
                            ...
                            />
                            <Label htmlFor={`followUpDone-${quote.id}`} className="text-xs cursor-pointer">
                              Realizado?
                            </Label>
                          </div>
                        )}
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          onClick={() => handleDeleteAttachment(quote)}
