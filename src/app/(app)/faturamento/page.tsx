...
export default function FaturamentoPage() {
  ...
  const handleSelectSale = (sale: Sale) => {
    ...
    // Optionally pre-fill some fields or reset billing form
    setBillingInfo('');
    setBillingAmount(sale.salesValue); // Pre-fill with sale value as a starting point
    setRecipientEmail(''); // Clear previous email
  };
  ...
  return (
    <div className="space-y-6" id="faturamento-printable-area">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 print-hide">
        ...
        <Button onClick={handlePrint} variant="outline" size="icon" disabled={!selectedSale}>
      ...
      <style jsx global>{`
        @media print {
          ...
          #faturamento-printable-area, #faturamento-printable-area * {
            visibility: visible;
          }
          .printable-content, .printable-content * { /* Specific content to print */
             visibility: visible;
          }
          ...
          @page {
            size: A4 portrait; /* Vertical A4 */
            margin: 15mm; /* Margins for A4 */
          }
          ...
          h1, h2, h3, h4, h5 {
             font-size: inherit !important; /* Reset heading sizes for print if needed */
          }
          hr {
